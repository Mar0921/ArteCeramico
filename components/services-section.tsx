...
const serviceMapping: Record<string, { servicio: string; tipoTrabajo: string[]; material: string[] }> = {
  "Provisional PMMA": { servicio: "Provisional PMMA", tipoTrabajo: ["PROVISIONAL"], material: ["PMMA"] },
  "Provisional sobreimplante": { servicio: "Provisional sobreimplante", tipoTrabajo: ["PROVISIONAL"], material: ["PMMA"] },
  "Híbrida PMMA unidad": { servicio: "Híbrida PMMA unidad", tipoTrabajo: ["HÍBRIDA"], material: ["PMMA"] },
  "Plato base con rodete": { servicio: "Plato base con rodete", tipoTrabajo: ["PRÓTESIS FIJA"], material: ["PMMA"] },
  "Encerado DX": { servicio: "Encerado DX", tipoTrabajo: ["ENCERADO DX"], material: [] },
  "Encerado guía": { servicio: "Encerado guía", tipoTrabajo: ["ENCERADO DX"], material: [] },
  "Microfresado": { servicio: "Microfresado", tipoTrabajo: ["SUB ESTRUCTURA"], material: ["ZIRCONIO"] },
  "Corona MP atornillada": { servicio: "Corona MP atornillada", tipoTrabajo: ["CORONA SOBRE IMPLANTE"], material: ["ZIRCONIO"] },
  "Corona atornillada disilicato": { servicio: "Corona atornillada disilicato", tipoTrabajo: ["CORONA SOBRE IMPLANTE"], material: ["DISILICATO"] },
  "Corona atornillada zirconio": { servicio: "Corona atornillada zirconio", tipoTrabajo: ["CORONA SOBRE IMPLANTE"], material: ["ZIRCONIO"] },
  "Corona disilicato maquillada": { servicio: "Corona disilicato maquillada", tipoTrabajo: ["CORONA"], material: ["DISILICATO"] },
  "Carilla disilicato": { servicio: "Carilla disilicato", tipoTrabajo: ["CARILLA"], material: ["DISILICATO"] },
  "Incrustación disilicato": { servicio: "Incrustación disilicato", tipoTrabajo: ["INCRUSTACIÓN"], material: ["DISILICATO"] },
  "Apoyo disilicato": { servicio: "Apoyo disilicato", tipoTrabajo: ["SUB ESTRUCTURA"], material: ["DISILICATO"] },
  "Corona zirconio maquillada": { servicio: "Corona zirconio maquillada", tipoTrabajo: ["CORONA"], material: ["ZIRCONIO"] },
  "Incrustación zirconio": { servicio: "Incrustación zirconio", tipoTrabajo: ["INCRUSTACIÓN"], material: ["ZIRCONIO"] },
  "Apoyo balcón zirconio": { servicio: "Apoyo balcón zirconio", tipoTrabajo: ["SUB ESTRUCTURA"], material: ["ZIRCONIO"] },
  "Corona metal porcelana": { servicio: "Corona metal porcelana", tipoTrabajo: ["CORONA"], material: ["METAL-CERÁMICA"] },
  "Híbrida metal-acrílico (Duratone)": { servicio: "Híbrida metal-acrílico (Duratone)", tipoTrabajo: ["HÍBRIDA"], material: ["METAL-ACRÍLICO"] },
  "Híbrida metal-porcelana unidad": { servicio: "Híbrida metal-porcelana unidad", tipoTrabajo: ["HÍBRIDA"], material: ["METAL-PORCELANA"] },
  "Modelos 3D completos": { servicio: "Modelos 3D completos", tipoTrabajo: [], material: [] },
  "Modelos 3D media arcada": { servicio: "Modelos 3D media arcada", tipoTrabajo: [], material: [] },
  "Carillas impresas c/u": { servicio: "Carillas impresas c/u", tipoTrabajo: ["CARILLA"], material: ["RESINA"] },
  "Coronas impresas c/u": { servicio: "Coronas impresas c/u", tipoTrabajo: ["CORONA"], material: ["RESINA"] },
  "Incrustaciones impresas c/u": { servicio: "Incrustaciones impresas c/u", tipoTrabajo: ["INCRUSTACIÓN"], material: ["RESINA"] },
}
