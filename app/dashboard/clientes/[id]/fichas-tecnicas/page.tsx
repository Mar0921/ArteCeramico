...
export default function FichasTecnicasPage() {
  ...
  const crearFichaCoronaZirconioEstratificadaVacia = (): Seccion[] => [
    {
      titulo: "1. Información de Identificación y Trazabilidad",
      campos: [
        { label: "Nombre del paciente", value: "" },
        { label: "Prescriptor", value: "" },
        { label: "Clasificación de DMSMB", value: "Línea de protesis fija / corona en zirconio estratificada" },
        { label: "Número de Serie o identificación del dispositivo", value: "" },
      ],
    },
    {
      ...
      campos: [
        {
          label: "Descripción técnica del dispositivo médico",
          value: "Corona dental fija elaborada en zirconio monolítico con estratificación cerámica feldespática en zona estética. Estructura interna en dióxido de zirconio de grado médico, recubierta parcialmente con porcelana dental para caracterización anatómica, funcional y estética. Diseñada de forma personalizada a partir de la anatomía dental del paciente mediante tecnología CAD/CAM.",
        },
        {
          label: "Uso previsto",
          value: "Restauración protésica fija destinada a reemplazar la estructura coronaria de uno o varios dientes afectados por caries extensas, fracturas, desgaste severo o tratamientos endodónticos. Su función es restablecer la anatomía, función masticatoria, estética dental y protección del remanente dentario.",
        },
        {
          label: "Materiales Empleados",
          value: "Dióxido de zirconio (ZrO₂) grado médico para la cofia o estructura interna; cerámica feldespática de recubrimiento para estratificación estética; pigmentos y maquillajes cerámicos dentales; cemento de fijación dental según prescripción clínica. Todos los materiales son biocompatibles y aptos para uso odontológico. Se debe registrar la marca comercial, referencia y número de lote de todos los materiales utilizados en la fabricación del dispositivo médico sobre medida bucal.",
        },
        {
          label: "Vida útil estimada",
          value: "Entre 10 y 15 años bajo condiciones normales de uso, siempre que el paciente mantenga adecuados hábitos de higiene oral, controles odontológicos periódicos y ausencia de hábitos parafuncionales no controlados. La vida útil puede variar según las condiciones clínicas y funcionales del paciente.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      campos: [
        {
          label: "Análisis de riesgos",
          value: "La corona en zirconio estratificada es un dispositivo biocompatible diseñado para uso odontológico. Los riesgos potenciales son mínimos y pueden incluir sensibilidad temporal después de la cementación, molestias por ajustes oclusales, fractura de la porcelana de recubrimiento por traumatismos o fuerzas excesivas, y reacciones adversas asociadas a los materiales de cementación utilizados por el profesional tratante.\nMitigación de riesgos como por ejemplo ajustes, control dimensional, pruebas de resistencia.",
        },
        {
          label: "Advertencias y contraindicaciones",
          value: "No utilizar la corona como herramienta para abrir objetos o morder elementos duros (hielo, huesos, semillas). Contraindicada en pacientes con alergia conocida a alguno de los materiales utilizados en su fabricación o cementación.",
        },
        {
          label: "Instrucciones de uso",
          value: "Mantener una adecuada higiene oral mediante cepillado dental mínimo dos veces al día, uso de seda dental y controles odontológicos periódicos. Evitar hábitos que puedan generar sobrecarga mecánica sobre la restauración. Asistir a revisiones profesionales según indicación del odontólogo. En caso de fractura, desprendimiento o deterioro de la corona, acudir inmediatamente al profesional tratante para su evaluación y manejo.",
        },
        {
          label: "Instrucciones de mantenimiento",
          value: "Mantenga una adecuada higiene oral mediante cepillado dental después de cada comida utilizando un cepillo de cerdas suaves y crema dental.\nUtilice diariamente seda dental o cepillos interproximales para limpiar las zonas alrededor de la corona y prevenir la acumulación de placa bacteriana.\nAcuda a controles odontológicos periódicos, al menos cada seis meses o según la frecuencia indicada por su odontólogo, para evaluar el estado de la corona y los tejidos de soporte.\nEvite morder objetos duros como hielo, huesos, semillas, caramelos duros, bolígrafos o cualquier elemento que pueda generar fuerzas excesivas sobre la restauración.\nEvite hábitos perjudiciales como morder uñas, abrir envases con los dientes o sujetar objetos con la boca.\nSi presenta bruxismo (rechinar o apretar los dientes), utilice la férula oclusal recomendada por su odontólogo para proteger la corona y los dientes naturales.\nMantenga una alimentación equilibrada y reduzca el consumo frecuente de alimentos y bebidas con alto contenido de azúcar para favorecer la salud oral.\nInforme a su odontólogo si presenta dolor, sensibilidad persistente, movilidad de la corona, cambios en la mordida, fracturas, desgaste inusual o cualquier otra alteración.\nNo intente ajustar, reparar o cementar nuevamente la corona por cuenta propia; cualquier procedimiento debe ser realizado por un profesional odontológico.",
        },
      ],
    },
    {
  ...
  const crearFichaCoronaZirconioMonoliticaVacia = (): Seccion[] => [
    {
      titulo: "1. Información de Identificación y Trazabilidad",
      campos: [
        { label: "Nombre del paciente", value: "" },
...
ISO 15841: alambres para uso en ortodoncia`,
  ...
  const handleAbrirFicha = (tipo: string = "Carilla de Disilicato Estratificada") => {
    ...
    if (tipo === "Carilla de Disilicato Monolitica") {
      ...
      setTipoFichaActual(tipo)
    } else if (tipo === "Corona Zirconio Estratificada") {
      ficha = crearFichaCoronaZirconioEstratificadaVacia()
      setTipoFichaActual(tipo)
  ...
  return (
    <div className="space-y-6 mt-20">
      ...
      <motion.div
        ...
        transition={{ duration: 0.3 }}
        className="rounded-xl bg-card p-6 shadow-sm border border-border cursor-pointer hover:border-primary/50 transition-colors"
        onClick={() => handleAbrirFicha("Corona Zirconio Monolitica")}
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-primary">
            ...
            <div>
              <p className="text-sm text-muted-foreground">
                Ficha rápida de Corona en zirconio monolítica
              </p>
              <p className="text-lg font-semibold text-foreground">
      ...
      <motion.div
        ...
        transition={{ duration: 0.3 }}
        className="rounded-xl bg-card p-6 shadow-sm border border-border cursor-pointer hover:border-primary/50 transition-colors"
        onClick={() => handleAbrirFicha("Corona Zirconio Estratificada")}
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-primary">
            ...
            <div>
              <p className="text-sm text-muted-foreground">
                Ficha rápida de Corona en zirconio estratificada
              </p>
              <p className="text-lg font-semibold text-foreground">
